...
# Hardcoded for HC7N in Cha-C2
r1                  = Range(18.046172178659, 18.049743053694)
r2                  = Range(19.174033388401, 19.177878945897)
r3                  = Range(20.301910160598, 20.305969360178)
r4                  = Range(21.429792640502, 21.434065481902)
r5                  = Range(22.557647180511, 22.562164184278)
r6                  = Range(23.685526167043, 23.690256813169)
r7                  = Range(24.813397647602, 24.818341935811)
r8                  = Range(25.941273115830, 25.946431046120)
...
inputFile           = myDirInput+"cha-c2-hc7n (2).lis"
...
selectedLines       = {"1": r1, "2": r2, "3": r3, "4": r4, "5": r5, "6": r6, "7": r7, "8": r8}, 
...
temp 	            = {'min':2.75,   'max':12.0,   'nstep':1, 'log_mode':False},
fwhm 	            = {'min':0.2,    'max':1.5,    'nstep':1, 'log_mode':False},
size 	            = {'min':10,     'max':90,     'nstep':1, 'log_mode':False},
vlsr 	            = {'min':3.5,    'max':5.5,    'nstep':1, 'log_mode':False},
